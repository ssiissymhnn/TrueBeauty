      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              "14개 화면 요소는 아래 다섯 가지 가치로 묶어 생각할 수 있습니다. 각 항목이 어떤 화면 정보와 연결되는지도 함께 적어 두었습니다.",
            ],
            list: [
              "즉시 인지 — 제품 사진·트루 인증 배지, 브랜드·제품명·한줄평, 브랜드 소개로 어떤 제품인지 바로 파악합니다.",
              "신뢰 검증 — 신뢰도·광고 의심 지표, 마케팅 주장 vs 실후기 대조, 신뢰 게이지·광고 의심 세부 항목으로 후기를 검증합니다.",
              "진짜 경험 — 5축 속성 차트, 피부타입별 리뷰 분포, 타입별 만족도, 장·단점 키워드 TOP3로 실제 사용 경험을 확인합니다.",
              "나에게 맞춤 — '나에게 적합할까요?' 판단과 피부타입별 맞춤 인사이트로 내 조건에 맞는지 살펴봅니다.",
              "구매 이득 — 판매처별 가격·최저가 비교, 최저가 추이 차트로 구매 타이밍을 판단합니다.",
            ],
          },
          {
            heading: "마무리",
